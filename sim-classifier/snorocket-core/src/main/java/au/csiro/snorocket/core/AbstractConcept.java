...
public abstract class AbstractConcept implements Comparable<AbstractConcept> {
    ...
    /**
     * Called to compare this object with the specified object when the {@link #hashCode}s are equal.
     * @param other the Object to be compared.
     * 
     * @return a negative integer, zero, or a positive integer as this object is less than, equal to, or greater than the specified object.
     * @see {@link #compareTo(AbstractConcept)}, {@link Comparable#compareTo(Object)}
     */
    abstract int compareToWhenHashCodesEqual(AbstractConcept other);

    /**
     * Default {@link Comparable#compareTo(Object)} implementation that calls {@link #compareToWhenHashCodesEqual(AbstractConcept)}
     * if and only if the {@link #hashCode()} values of {@code this} and {@code other} are equal.
     * 
     * @return a negative integer, zero, or a positive integer as this object is less than, equal to, or greater than the specified object.
     */
    public int compareTo(AbstractConcept other) {
        ...
        int result = 0 == meta ? (0 == quickCompare ? compareToWhenHashCodesEqual(other) : quickCompare) : meta;
