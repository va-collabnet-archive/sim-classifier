...
public class DebugUtils {
	...
	public static String formatAxiom(OWLAxiom a, OWLOntology ont) {
		if(a instanceof OWLSubPropertyChainOfAxiom) {
			...
			String name = (ent.isOWLClass()) ? 
					getLabel(ent.asOWLClass(), ont) : ent.toString();
			return "init("+name+")";
		} else {
			return a.toString();
		}
	...
	public static String formatClassExpression(OWLClassExpression ce, 
		...
		if(ce instanceof OWLClass) {
			...
			String role = (!ope.isAnonymous()) ? 
					getLabel(ope.asOWLObjectProperty(), ont) : ope.toString();
			return "\u2203"+role+".("+
	...
	public static void main(String[] args) {
		String[] vals = new String[] {
				"http://www.ihtsdo.org/SCT_424226004"
		};
