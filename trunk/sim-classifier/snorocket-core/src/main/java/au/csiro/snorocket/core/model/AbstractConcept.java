...
public abstract class AbstractConcept implements Comparable<AbstractConcept> {
     ...
     * {@link #compareToWhenHashCodesEqual(AbstractConcept)}
     * if and only if the {@link #hashCode()} values of {@code this} and 
     * {@code other} are equal.
     * 
     * @return a negative integer, zero, or a positive integer as this object is
     * less than, equal to, or greater than the specified object.
     */
    public int compareTo(AbstractConcept other) {
        ...
        int result = 0 == meta ? (0 == quickCompare ? 
        		compareToWhenHashCodesEqual(other) : quickCompare) : meta;
