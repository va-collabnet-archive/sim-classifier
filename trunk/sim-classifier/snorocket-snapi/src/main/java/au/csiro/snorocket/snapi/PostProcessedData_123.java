...
public class PostProcessedData_123 {
    ...
    PostProcessedData_123(final IFactory_123 factory2, final IConceptMap<IConceptSet> subsumptions) {
...
//      children = new DenseConceptMap<ConceptSet>(factory.getTotalConcepts());
    ...
    PostProcessedData_123(final IFactory_123 factory, final IConceptMap<IConceptSet> baseSubsumptions, final IConceptMap<IConceptSet> deltaSubsumptions) {
